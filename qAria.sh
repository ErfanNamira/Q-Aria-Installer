...
install_ariafileserver_http() {
    ...
    # Generate SHA-256 hash using passlib's sha256_crypt
    hashed_password=$(python3 -c "from passlib.hash import sha256_crypt; print(sha256_crypt.using(rounds=535000).hash('$password'))")
